...
export function projectDataDir(projectRoot: string, dataRoot = defaultDataRoot()): string {
...
function moveDirectory(source: string, destination: string, fs: MigrationFs): void {
  try {
